...
isOwnProperty=input("Enter either Y for Yes or N for No: n").upper()
...
isOwnPropertyBefore=input("Enter either Y for Yes or N for No: n").upper()
...
if numberOfIndustrialProperty ==1:
    ...
    isOperatingBusiness=input("Enter either Y for Yes or N for No: n").upper()
